...
Student Name: Ahmed M M D AlShamy
Student ID: 201536675
Email: sc21a3s@leeds.ac.uk
Date Work Commenced: 11/11/21 (DEADLINE EXTENSION GRANTED FROM SCSSO TO 17/11/21)
...
if (26 <= QWaterConsumption && QWaterConsumption <= 40){
QFreshWaterCharge = (QWaterConsumption - 25)*0.75 + (13)*0.50 + (7)*0.35 + (5)*0.20;
}

if (13 <= QWaterConsumption && QWaterConsumption <= 25){
QFreshWaterCharge = (QWaterConsumption - 12)*0.50 + ((7)*0.35 + (5)*0.20);
}

if (6 <= QWaterConsumption && QWaterConsumption <= 12){
...
if ((QFreshWaterCharge + QStandingCharges + QSurfaceWaterCharge + QWasteWaterCharge)  > QMaxDomesticBill){
    QMaxDomesticBill = (QFreshWaterCharge + QStandingCharges + QSurfaceWaterCharge + QWasteWaterCharge);
}
QTotalDomesticCharge += (QFreshWaterCharge + QStandingCharges + QSurfaceWaterCharge + QWasteWaterCharge);
